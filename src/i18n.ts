...
export interface Dict {
  nav: { services: string; sovereign: string; research: string; contact: string; register: string };
  hero: {
    eyebrow: string;
    titleA: string;
    titleB: string;
...
export const dicts: Record<Lang, Dict> = {
  ...
  fr: {
    nav: { services: 'Services', sovereign: 'IA souveraine', research: 'Recherche', contact: 'Contact', register: 'Démarrer' },
    hero: {
  ...
  ar: {
    ...
    services: {
      ...
      items: [
        { key: 'agentic_solutions', title: 'حلول وكيلية مخصصة', desc: 'قوى عاملة ذاتية لفرق الإدارة والمحاسبة والتطوير. وكلاء يتعلمون إجراءاتك وينفذونها.', tag: 'إدارة · محاسبة · تطوير' },
    ...
    register: {
      ...
      submit: 'إرسال الطلب', success: 'تم استلام الطلب. سيتواصل معك فريقنا قريباً.', error: 'فشل الإرسال. تحقق من الحقول وحاول مجدداً.', optional: 'اختياري',
    },
